...
const definitions: Record<string, CLIOptionDefinitions> = {
  "assess-distribution": {
    ...
    feature: { type: "string", description: "feature key to evaluate", demandOption: true },
  ...
  lint: {
    ...
    entityType: {
      type: "string",
      choices: ["feature", "segment", "group", "schema", "attribute", "target", "test"],
    },
  ...
  list: {
    ...
    tests: { type: "boolean" },
    target: { type: "array", description: "filter features by one or more targets" },
    entityType: { type: "string", choices: ["feature", "segment"] },
    ...
    tag: { type: "array", description: "filter features by one or more tags" },
